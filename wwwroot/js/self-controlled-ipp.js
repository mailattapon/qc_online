const selfControlledIPP = Vue.component('self-controlled-ipp', {
  template: `
    <div>
      <button class="btn btn-link" @click="handleClick"><i class="fas fa-plus-square fa-3x"></i></button>

      <div class="modal fade" id="ipp-modal" tabindex="-1" role="dialog" aria-labelledby="ipp-title" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="ipp-title">Upload supplier self-controlled IPP</h5>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-12 d-flex form-group">
                    <div class="fix-first-column"><label for="vendor" class="col-form-label font-weight-bold">Month</label></div>
  ...
  methods: {
    ...
    validate: function() {
      ...
      if (this.month && this.year) {
        ...
        const selectedDate = new Date(`${this.year}-${this.month}-01`);
    ...
    handleSubmit: function() {
      ...
      this.saving = true;
      axios
        .post('/selfcontrolledipp', form, options)
        .then(res => {
          this.saving = false;
          $('#ipp-modal').modal('hide');
...
const vueApp = new Vue({
  el: '#self-controlled-ipp',
  components: {
    'self-controlled-ipp': selfControlledIPP
  }
});
