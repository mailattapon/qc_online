...
const supplierInformation = Vue.component('supplier-information', {
  template: `
    <div>
      <button class="btn btn-link" @click="handleClick"><i class="fas fa-plus-square fa-3x"></i></button>
      <div class="modal fade" id="supplier-information-modal" tabindex="-1" role="dialog" aria-labelledby="supplier-information-title" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="supplier-information-title">Add Supplier Information</h5>
  ...
  methods: {
    ...
    handleSubmit: function() {
      ...
      this.saving = true;
      axios
        .post(`/supplierInformation`, form, options)
        .then(res => {
          this.saving = false;
          $('#supplier-information-modal').modal('hide');
    ...
    handleClick: function() {
      ...
      this.fileName = null;
      $('#supplier-information-modal').modal('show');
    }
  }
});

const vueApp = new Vue({
  el: '#supplier-information',
  components: {
